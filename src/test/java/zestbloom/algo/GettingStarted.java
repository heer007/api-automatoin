...
class GettingStarted{
    ...
    private AlgodClient connectToNetwork() {
        final String ALGOD_API_ADDR = "https://ion.testnet.zestbloom.com";
    ...
    public void firstTransaction(Account myAccount) throws Exception {
        ...
        try {
            ...
            final String RECEIVER = "HSFOQVFCVG5VEZC3RIYPVKUXNCGPO4QC6EYVFIGJCYFLGN4YHI4SGPLGXI";
